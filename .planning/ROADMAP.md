...
- [ ] 01-01: Verify the exact Phase 1 npm package identities before installation.

**Wave 1** *(blocked on Wave 0 completion)*

- [ ] 01-02: Establish the approved Node, TypeScript, and one-shot unit-test foundation.
...
- [ ] 01-04: Implement the main-domain tracer state machine and output commit barrier.

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 01-05: Establish hardened Electron windows, role-limited IPC, and network denial.
...
- [ ] 01-08: Compose the production main-owned hotkey-to-output tracer path.

**Wave 6** *(blocked on Wave 5 completion)*

- [ ] 01-09: Deliver the accessible overlay and minimum control-window contract.

**Wave 7** *(blocked on Wave 6 completion)*

- [ ] 01-10: Converge REUSE, provenance, notices, dependency review, and development SBOM evidence.
...
|-------|----------------|--------|-----------|
| 1. Secure Electron walking skeleton | 0/12 | Ready to execute | - |
